...
const GroupList = ({ myGroups, authToken }) => {
  ...
  return (
    <div className="space-y-[5px] w-full m-auto justify-center pt-[50px] bg-gray-100 min-h-screen">
      ...
      {myGroups && <div className='flex w-full justify-center align-middle'><NavLink to="/create-group"
            className={`flex flex-1 items-center justify-between mx-4 py-2 rounded-lg transition duration-300 bg-blue-500 max-w-[500px] mb-[8px] hover:bg-blue-600 text-white cursor-pointer`}
          >
