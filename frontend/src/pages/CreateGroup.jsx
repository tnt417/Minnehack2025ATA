...
export default function CreateGroup()
{
  ...
  return (
    <div className="max-w-lg mx-auto font-roboto_condensed text-black mt-[50px] px-[10px] rounded-xl shadow-lg">
      <br></br>
      <h2 className="text-xl font-extrabold font-roboto_slab text-maroon_dark mb-4">Create a Group</h2>
      <form className="overflow-y-scroll max-h-[90vh]" onSubmit={handleSubmit} style={{
        ...
        <div><button type="submit" className={`text-white mt-4 px-4 w-full py-2 rounded ${validateData() ? 'bg-maroon_new opacity-100' : 'bg-maroon_new pointer-events-none opacity-40'}`}>{"Create"}</button></div>
